    ...
    public function handle()
    {
        ...
        foreach($menuItems as $menuItem){
            if ($menuItem['generate_permission'] == 'ALL'){
                Permission::updateOrCreate(['permission_type_id' => $this->cPermission['id'], 'menu_item_id' => $menuItem['id']],['name' => 'create'.str_replace('/','_',strtolower($menuItem['route']))]);
                Permission::updateOrCreate(['permission_type_id' => $this->rPermission['id'], 'menu_item_id' => $menuItem['id']],['name' => 'read'.str_replace('/','_',strtolower($menuItem['route']))]);
                Permission::updateOrCreate(['permission_type_id' => $this->uPermission['id'], 'menu_item_id' => $menuItem['id']],['name' => 'update'.str_replace('/','_',strtolower($menuItem['route']))]);
                Permission::updateOrCreate(['permission_type_id' => $this->dPermission['id'], 'menu_item_id' => $menuItem['id']],['name' => 'delete'.str_replace('/','_',strtolower($menuItem['route']))]);
            }
